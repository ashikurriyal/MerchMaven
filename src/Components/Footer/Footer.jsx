import logo from '../../assets/MerchMaven.png'
    ...
    return (
        <div className="mt-8">
            <footer className="px-4 bg-gray-100 divide-y dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">Merch Maven</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-600">©All rights reserved by Merch Maven</div>
            </footer>
        </div>
    );
};
